...
Чтобы запустить лабораторную работу с нужным вам номером.
Укажите в `CMakeLists.txt` в поле 
<code>set(LAB_INDEX <b style="color: yellow">5</b>)</code>
вместо **5** нужный номер лабораторной работы.
...
Дана строка, содержащая от 1 до 30 слов, в каждом из которых от
1 до 10 латинских букв и/или цифр; между соседними словами – запятая,
за последним словом – точка. Напечатать эту же последовательность слов,
...
Данные о пассажирах авиакомпании: номер рейса, дата рейса, ФИО пассажира, номер места в самолете, вес багажа в кг.